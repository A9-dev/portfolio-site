...
worklog:
  - type: "leetcode"
    area: ["prefix sum", "hashmap", "sliding window"]
    summary: "solved 8 problems: Find the Highest Altitude, Find Pivot Index, Unique Number of Occurrences, Find the Difference of Two Arrays, Maximum Number of Vowels in a Substring of Given Length, Max Consecutive Ones III, Longest Subarray of 1s After Deleting One Element, Determine if Two Strings Are Close"
---
