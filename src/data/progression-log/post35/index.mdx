...
- **Replication and Tunable Consistency** - replicating data across multiple nodes improves read availability and fault tolerance. Quorum-based reads and writes let you tune the balance between consistency and availability, while multi-data center replication helps the system tolerate larger outages.
