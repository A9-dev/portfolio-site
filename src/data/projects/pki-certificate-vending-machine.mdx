---
title: "API-Driven Certificate Issuer with Terraform, AWS, and Go"
...
tags:
  ...
  - IAM
  - Lambda
coverImage: "./pki-certificate-vending-machine/cover-hero.jpg"
seo:
...
import coverHero from "./pki-certificate-vending-machine/cover-hero.jpg";
...
<Image src={coverHero} alt="Cover image for the certificate issuer project" width={1200} format="webp" quality={90} />
...
![Architecture diagram](/images/projects/pki-certificate-vending-machine/architecture.svg)
